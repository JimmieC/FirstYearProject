...
$user = $_GET["user"]; // Variablen user hämtas från GET.

$link = "http://schema.mah.se/setup/jsp/SchemaICAL.ics?startDatum=idag&intervallTyp=m&intervallAntal=6&sprak=SV&sokMedAND=true&forklaringar=true&resurser=s.$user";

$storeArray = array();

array_push($storeArray, $link);
    
   
$list_webcals = $storeArray;
